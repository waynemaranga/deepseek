...
function makeRequest(prompt_1) {
  return __awaiter(
    this,
    arguments,
    void 0,
    function (prompt, model, systemRole, stream) {
      var baseURL, headers, payload, response, error_1;
      if (model === void 0) {
        model = "deepseek-chat";
      }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            console.error(
              "Request failed:",
              error_1.response ? error_1.response.data : error_1.message
            );
            return [3 /*break*/, 4];
          case 4:
            return [2 /*return*/];
